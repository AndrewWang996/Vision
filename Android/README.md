...
* Vision is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as Vision is mean to act as a starting point for Android Applications.

# Vision App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-opencv-andy-vision.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-opencv-andy-vision)

This repository contains the source code for the [Vision](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.opencv.andy.vision).

Please see the [issues](https://github.com.opencv.andy.vision/com-opencv-andy-vision/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Vision? Ask away on the [com-opencv-andy-vision discussion forum](https://groups.google.com/forum/#!forum/com-opencv-andy-vision).

<a href="https://play.google.com/store/apps/details?id=com.opencv.andy.vision" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.opencv.andy.vision__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.opencv.andy.vision__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.opencv.andy.vision.R__) will now be renamed
...
signed with a different key.  Manually uninstall Vision from your device and
...
Vision is a result of a template project I've developed over the years as well as
...
Vision is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.opencv.andy.vision/com-opencv-andy-vision/contributors) on
...
[pull requests](https://github.com.opencv.andy.vision/com-opencv-andy-vision/pulls).
