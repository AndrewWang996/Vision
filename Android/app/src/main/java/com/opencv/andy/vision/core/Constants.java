...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.opencv.andy.vision";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Vision";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.opencv.andy.vision.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.opencv.andy.vision.";
